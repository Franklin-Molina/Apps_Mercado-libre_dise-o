                ...
                children: <Widget>[
                  Expanded(child: Column(
                    ...
                    children: <Widget>[
                        ...
                        Text("Portatil Gamer Acer Nitro 5 Fhd 256gb Ssd An515-51-55wl",style: TextStyle( fontSize: 24,fontWeight: FontWeight.w300,color: Colors.black),),
                        SizedBox(height: 15.0,),
                         ...
                         SizedBox(height: 15.0,),
                        Text(" \$ 5.007.990",style: TextStyle( fontSize: 30,fontWeight: FontWeight.w300,color: Colors.black),),
                        SizedBox(height: 15.0,),
                         
                        Text("Disponible en 2 días apartir de tu compra",style: TextStyle(color: Colors.orange),),
